...
class ArtistsControllerIT {
    @Autowired
    private val controller: ArtistsController? = null
    @Test
    fun givenArtistOnDb_whenGettingArtist_thenReturnArtistNoError() {
        ...
        Assertions.assertThat(artistsById.statusCode).isEqualTo(HttpStatus.NOT_FOUND)
    }
    ...
    fun givenArtistOnDb_whenGetByName_thenGetArtistByName() {
        ...
        Assertions.assertThat(artistsByName).isNotNull
        Assertions.assertThat(artistsByName.statusCode).isEqualTo(HttpStatus.OK)
        val artistsByNameBody = artistsByName.body
        Assertions.assertThat(artistsByNameBody).isNotNull
